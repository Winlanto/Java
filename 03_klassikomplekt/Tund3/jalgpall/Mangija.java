public class Mangija {
    ...
    public Mangija(String uusPerekonnanimi, double uusX,double  uusY, double uusNurkKraadides, double uusKiirus){
        perekonnanimi=uusPerekonnanimi;x=uusX;y=uusY;nurkRad=Math.toRadians(uusNurkKraadides); kiirus=uusKiirus;
    }
    public String toString(){
        return perekonnanimi+" ("+x+", "+y+") " +Math.round(Math.toDegrees(nurkRad))+" kraadi " + kiirus+"m/s";
    }
